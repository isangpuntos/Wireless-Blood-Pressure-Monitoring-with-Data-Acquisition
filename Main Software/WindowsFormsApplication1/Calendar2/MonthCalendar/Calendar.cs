...
namespace MonthCalendar
{
    ...
    public class Calendar : Control
    {
        ...
        public static int yyyy1 = 0;
        public static int yyyy12 = 0;
        public static string pub_sTitleText;
        ...
        public Button m_PreviousButton = null;
        ...
        public int valMonth
        {
            ...
            set
            {
                monthVal = m_SelectedMonthIndex + 1; 
            }
        }
        ...
        public string pub_Year
        {
            get
            {
                return pub_sTitleText;
            }
            set
            {

                pub_sTitleText = sTitleText;
            }
        }
        ...
        [Category("Calendar")]
        public event EventHandler PClick;

        [Category("Calendar")]
        public event EventHandler NClick;
        ...
        public void PrevClick(object sender, EventArgs e)
        {
            ...
            if (PClick != null) PClick(this, EventArgs.Empty);
            year1 = m_Start12YearsRange;
            year12 = m_End12YearsRange;
        ...
        public void NextClick(object sender, EventArgs e)
        {
            ...
            if (NClick != null) NClick(this, EventArgs.Empty);
            year1 = m_Start12YearsRange;
            year12 = m_End12YearsRange;
        }
